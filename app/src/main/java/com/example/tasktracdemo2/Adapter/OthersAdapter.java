...
public class OthersAdapter extends RecyclerView.Adapter<OthersAdapter.ViewHolder>{
    ...
    public OthersAdapter(DBHandler db, OthersActivity activity){
        this.db = db;
        this.othersActivity = activity;
    }
    ...
    public void onBindViewHolder(OthersAdapter.ViewHolder holder, int post){
        db.openDatabase();
    ...
    public Context getContextOthers() {
    ...
    public void editItem(int post){
        ...
        fragment.show(othersActivity.getSupportFragmentManager(), AddNewTask.TAG);
    }
